      ...
      >
        {displayItems.map((item, index) => (
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            className="flex items-start gap-3 py-6 px-6 lg:px-12 border border-[#0063B5] rounded-lg shadow-sm hover:shadow-md transition-all duration-300 cursor-pointer bg-white"
          >
            <motion.span
